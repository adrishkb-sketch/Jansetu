...
- Dynamic Specific Data Collection & Clarification: For all category tags, evaluate if the input contains necessary specific details to resolve it. If the user has ONLY uploaded a photo or image description without explaining what action they want taken (e.g., they show garbage/waste, a stray dog, or a broken facility but don't state if they need cleanup, rescue, relocation, or repairs), you MUST set 'requiresClarification' to true and ask them to clarify what specific request or action they want from the administration.
- Specific details needed per category:
  ...
  * environment / waste / garbage: Ask where exactly the trash is accumulated, how long it has been there, whether it's blocking drains, and what action is required.
  * safety / others: Ask for the exact nature of the hazard, street lighting status, or specific help needed.
  * agricultural / crop / animal: Ask about crop damage percentages, disease/pest types, or stray animal details and the required intervention.
  * other suggestions: proposed execution timeline, community benefits, target group.
  If these details are missing, set 'requiresClarification' to true and formulate a request in 'clarificationQuestion' asking for these details.
