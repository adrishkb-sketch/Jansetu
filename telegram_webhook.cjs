/**
 * Jansetu Webhook Telegram Chatbot Gateway
 * Deploy this Express server to free hosting (Render, Vercel, etc.)
 * to run your chatbot 24/7.
 * 
 * Install dependencies:
 *   npm install express node-telegram-bot-api firebase
 * 
 * Set Webhook URL:
 *   https://api.telegram.org/bot<TOKEN>/setWebhook?url=<YOUR_DEPLOYED_URL>/telegram-webhook
 */
...
try {
  ...
  console.warn("Failed to load constituencies_543.json", e.message);
}
